...
public class Actions {
	...
	public static final String GET_ALL_VERSIONS = "get_all_versions";
	...
	public static final String GET_ALL_ISSUES = "get_all_issues";
	public static final String GET_MATCHING_ISSUES = "get_matching_issues";
